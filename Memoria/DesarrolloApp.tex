...
\begin{document}
    \chapter{Desarrollo de la aplicación del test subjetivo.}
        ...
        \section{Codificación del script en Python}            
            ...
            Durante todo el proceso, las consultas a la documentación de la API de Python para GTK \cite{GTKAPI} y de las diferentes librerías necesarias para el desarrollo de la aplicación. COMPLETAR CON LIBRERIAS
